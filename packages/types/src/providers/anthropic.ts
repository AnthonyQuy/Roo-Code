...
export const anthropicModels = {
	...
	"claude-opus-4-7": {
		...
		// Claude Opus 4.7 uses adaptive thinking (thinking.type="adaptive" + output_config.effort).
		// The old budget_tokens API is not supported by this model.
		supportsReasoningEffort: ["low", "medium", "high", "xhigh"] as const,
